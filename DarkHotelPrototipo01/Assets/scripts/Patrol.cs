...
public class Patrol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else // Est� persiguiendo al jugador
        {
            float distance = Vector3.Distance(personajePrincipal.transform.position, transform.position);
    ...
    void CambiarEscena()
    {
        // Puedes cambiar de escena por nombre o por �ndice de build
        SceneManager.LoadScene("GameOver");
        // O puedes usar el �ndice de build de la escena:
        // SceneManager.LoadScene(1); // Cambia al �ndice de build correcto de tu escena
    }
}